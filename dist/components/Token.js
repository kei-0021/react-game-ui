...
export const Token = ({ token, onClick, onDoubleClick, onDragEnd }) => {
    const handleDragStart = (e) => { };
    return (_jsx("div", { className: styles.tokenContainer, onClick: (e) => onClick?.(e, token), onDoubleClick: (e) => onDoubleClick?.(e, token), draggable: true, onDragStart: handleDragStart, onDragEnd: (e) => onDragEnd?.(e, token), children: _jsx(TokenDisplayContent, { token: token }) }));
};
