 ...
 */
export declare function ScoreBoard({ socket, roomId, players, currentPlayerId, myPlayerId, playCardLimit, autoNextTurnOnCardPlay, revealButton, turnSkipButton, roundSkipbutton, isDebug, }: {
    socket: Socket;
    roomId: RoomId;
    players: Player[];
