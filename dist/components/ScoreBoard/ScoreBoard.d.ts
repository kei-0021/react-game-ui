 ...
 */
export declare function ScoreBoard({ socket, roomId, myPlayerId, currentPlayerId, players, playCardLimit, playCardButton, holdButton, flipButton, turnSkipButton, roundSkipButton, size, isDebug, enabled, }: ScoreBoardProps): import("react/jsx-runtime").JSX.Element;
export {};
