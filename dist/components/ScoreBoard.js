 ...
 */
export function ScoreBoard({ socket, players, currentPlayerId, myPlayerId, roomId, playCardLimit, autoNextTurnOnCardPlay = false, roundSkip = false, isDebug = false, }) {
